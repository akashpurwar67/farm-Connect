...
import {getMarketData,sendMarketData,sendListedMarketData,deleteMarketData,updateMarketData} from '../controllers/item.controller.js';
...
router.get('/getlisteditem',protectRoute,sendListedMarketData);
